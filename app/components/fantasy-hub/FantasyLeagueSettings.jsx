...
function ToggleInput({ label, path, checked, onUpdate }) {
  return (
    ...
    >
      <span style={{ color: "var(--text-primary)", fontSize: 14, fontWeight: 700 }}>{label}</span>
      <input
        type="checkbox"
        checked={checked}
        ...
        <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "center", flexWrap: "wrap" }}>
          ...
          {section.collapsible ? (
            <button
              ...
              style={{
                borderRadius: 999,
                border: `1px solid ${advancedOpen ? "#2fb4ff" : "var(--border-strong)"}`,
                background: advancedOpen ? "rgba(47,180,255,0.14)" : "var(--bg-card)",
                color: advancedOpen ? "var(--text-primary)" : "var(--text-secondary)",
                padding: "7px 10px",
                fontSize: 10,
                fontWeight: 800,
                letterSpacing: "0.08em",
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", gap: 16, alignItems: "start", flexWrap: "wrap" }}>
        ...
        <button
          ...
          style={{
            borderRadius: 999,
            border: `1px solid ${collapsed ? "var(--border-strong)" : "#2fb4ff"}`,
      ...
      <div className="fantasy-league-overview-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: 10 }}>
        <div style={{ borderRadius: 16, border: "1px solid var(--border-strong)", background: "var(--bg-card)", padding: "12px 12px 10px", display: "grid", gap: 6 }}>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            {[
              ...
              <button
                ...
                style={{
                  borderRadius: 999,
                  border: `1px solid ${state.settings.leagueType === value ? "#2fb4ff" : "var(--border-strong)"}`,
                  background: state.settings.leagueType === value ? "rgba(47,180,255,0.14)" : "var(--bg-card)",
                  color: state.settings.leagueType === value ? "var(--text-primary)" : "var(--text-secondary)",
                  padding: "9px 12px",
                  fontSize: 12,
                  fontWeight: 800,
