...
export default function FantasyHubApp() {
  ...
  const header = (
    ...
    >
      ...
      <div style={{ color: "var(--text-secondary)", fontSize: 14, lineHeight: 1.5, maxWidth: 860 }}>
      ...
      <div style={{ display: "grid", gap: 18 }}>
        ...
        <section style={{ display: "grid", gap: 10 }}>
          <div>
            ...
            <div style={{ color: "var(--text-muted)", fontSize: 14, lineHeight: 1.6, maxWidth: 760, marginTop: 6 }}>
